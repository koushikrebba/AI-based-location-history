...
import History from '../assets/history1.jpeg'
...
function SignUp() {
    ...
    return (
        ...
        <div className="">
        <form onSubmit={handleSubmit(onSignupFormSubmit)} className="max-w-sm mx-auto pt-3 pb-3 ps-3 border rounded-3" style={{width:"600px", boxShadow: "rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px"}}>
        ...
        <div className="relative mt-6 mb-8 w-full min-w-[200px] h-10">
          ...
          <div className="relative mt-6 mb-8 w-full min-w-[200px] h-10">
            ...
            {errors.lastname?.type === "required" && (
              <p className="text-red-500">Enter your last name</p>
            )}
            </div>
          </div>
          <div className="relative mt-6 mb-8 w-full min-w-[200px] h-10">
          ...
          <div className="relative mt-6 mb-8 w-full min-w-[200px] h-10">
            ...
            {errors.password?.type === 'required' && <p className='text-danger'>Password is required</p>}
                    {errors.password?.type === 'minLength' && <p className='text-danger'>Password minimium Length is 6</p>}
